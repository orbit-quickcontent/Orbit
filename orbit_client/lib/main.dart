  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        primaryColor: const Color(0xFF00F0FF), // Orbit Cyan
        colorScheme: const ColorScheme.dark(
          primary: Color(0xFF00F0FF),
          secondary: Color(0xFF8A2BE2), // Orbit Purple
          surface: Color(0xFF121212),
        ),
        useMaterial3: true,
      ),
      home: home ?? const WebViewContainer(),
    );
  }
}
...
class _WebViewContainerState extends State<WebViewContainer> {
  ...
  String _currentUrl = "http://10.0.2.2:3000/?role=USER";
  ...
  Future<void> _loadSavedUrl() async {
    ...
    final savedUrl = prefs.getString('orbit_client_server_url');
  ...
  Future<void> _saveUrl(String url) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('orbit_client_server_url', url);
    setState(() {
      _currentUrl = url;
      _hasError = false;
      _isLoading = true;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Row(
                children: [
                  Icon(Icons.settings, color: Color(0xFF00F0FF)),
                  SizedBox(width: 8),
                  Text(
              ...
              const Text(
                'Enter the URL of your Next.js server. Use http://10.0.2.2:3000/?role=USER for local Android Emulator or your local IP if running on a real device.',
                style: TextStyle(
                  fontSize: 12,
                  color: Colors.grey,
                ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g. http://10.0.2.2:3000/?role=USER',
