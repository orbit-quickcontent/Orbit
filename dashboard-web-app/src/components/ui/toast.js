const _jsxFileName = "src\\components\\ui\\toast.tsx";"use client";
...
(({ className, ...props }, ref) => (
  React.createElement(ToastPrimitives.Close, {
    ...
    , React.createElement(X, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 86}} )
  )
))
