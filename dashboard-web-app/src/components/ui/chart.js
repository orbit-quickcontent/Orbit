...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      return (
        React.createElement('div', { className: cn("font-medium", labelClassName), __self: this, __source: {fileName: _jsxFileName, lineNumber: 147}}
    ...
    return React.createElement('div', { className: cn("font-medium", labelClassName), __self: this, __source: {fileName: _jsxFileName, lineNumber: 157}}, value)
  }, [
    label,
    labelFormatter,
    payload,
  ...
  return (
    React.createElement('div', {
      ...
      , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 182}}
              ...
              , formatter && _optionalChain([item, 'optionalAccess', _10 => _10.value]) !== undefined && item.name ? (
                ...
                React.createElement(React.Fragment, null
                  , _optionalChain([itemConfig, 'optionalAccess', _11 => _11.icon]) ? (
                    React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 201}} )
                  ) : (
                    !hideIndicator && (
                      React.createElement('div', {
                        className: cn(
                  ...
                  , React.createElement('div', {
                    ...
                    , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 230}}
                      , nestLabel ? tooltipLabel : null
                      , React.createElement('span', { className: "text-muted-foreground", __self: this, __source: {fileName: _jsxFileName, lineNumber: 232}}
                        , _optionalChain([itemConfig, 'optionalAccess', _12 => _12.label]) || item.name
                      )
                    )
                    , item.value && (
                      React.createElement('span', { className: "text-foreground font-mono font-medium tabular-nums"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 237}}
        ...
        return (
          React.createElement('div', {
            ...
            , _optionalChain([itemConfig, 'optionalAccess', _14 => _14.icon]) && !hideIcon ? (
              React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 291}} )
            ) : (
              React.createElement('div', {
