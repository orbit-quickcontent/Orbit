const _jsxFileName = "src\\shared\\frontend\\animated-background.tsx";"use client";
...
export default function AnimatedBackground() {
  ...
  return (
    React.createElement('div', { className: "absolute inset-0 overflow-hidden pointer-events-none"   , 'aria-hidden': "true", __self: this, __source: {fileName: _jsxFileName, lineNumber: 125}}
      /* Inline keyframes — only injected once per DOM */
      , shouldInjectStyles && (
        React.createElement('style', { id: STYLE_ID, __self: this, __source: {fileName: _jsxFileName, lineNumber: 128}}, `
