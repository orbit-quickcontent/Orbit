...
export async function POST(request) {
  try {
    ...
    const user = await targetCol.create({
      data: {
        email,
        name: _nullishCoalesce(name, () => ( null)),
        phone: _nullishCoalesce(phone, () => ( null)),
        location: _nullishCoalesce(location, () => ( null)),
        role: _nullishCoalesce(role, () => ( "USER")),
        brandLogo: _nullishCoalesce(brandLogo, () => ( null)),
        brandFont: _nullishCoalesce(brandFont, () => ( null)),
        brandColor: _nullishCoalesce(brandColor, () => ( null)),
        editorRequirements: _nullishCoalesce(editorRequirements, () => ( null)),
      },
    });
