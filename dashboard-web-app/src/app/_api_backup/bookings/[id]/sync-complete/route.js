  ...
  try {
      ...
      if (partner) {
        ...
        await firestoreDb.transactions.create({
          data: {
            ...
            status: "COMPLETED",
            description: `Salary payout for shoot ${bookingId.substring(0, 8)}... (${_nullishCoalesce(pkg.name, () => ( "Package"))})`,
          },
        });
      }
    }
    ...
    return NextResponse.json({
      ...
      booking: {
        ...
        footageUrls,
        fileName: fileName || (_nullishCoalesce(_optionalChain([footageUrls, 'access', _ => _[footageUrls.length - 1], 'optionalAccess', _2 => _2.split, 'call', _3 => _3("/"), 'access', _4 => _4.pop, 'call', _5 => _5()]), () => ( ""))),
        fileSize: fileSize || 0,
        editorRequirements: _optionalChain([updatedBooking, 'access', _6 => _6.user, 'optionalAccess', _7 => _7.editorRequirements]) || "",
        brandLogo: _optionalChain([updatedBooking, 'access', _8 => _8.user, 'optionalAccess', _9 => _9.brandLogo]) || null,
        brandFont: _optionalChain([updatedBooking, 'access', _10 => _10.user, 'optionalAccess', _11 => _11.brandFont]) || null,
        brandColor: _optionalChain([updatedBooking, 'access', _12 => _12.user, 'optionalAccess', _13 => _13.brandColor]) || null,
