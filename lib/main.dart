...
class _WebViewContainerState extends State<WebViewContainer> {
  ...
  String _currentUrl = "http://10.0.2.2:3000"; // Default to Android Emulator host
  ...
  Future<void> _loadSavedUrl() async {
    ...
    final savedUrl = prefs.getString('orbit_server_url');
  ...
  Future<void> _saveUrl(String url) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('orbit_server_url', url);
    setState(() {
      _currentUrl = url;
      _hasError = false;
      _isLoading = true;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Enter the URL of your Next.js server. Use http://10.0.2.2:3000 for local Android Emulator or your local IP if running on a real device.',
                style: TextStyle(
                  fontSize: 12,
                  color: Colors.grey,
                ),
